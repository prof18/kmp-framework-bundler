...
import com.prof18.kmp.framework.bundler.testutils.extractKotlinVersion
import com.prof18.kmp.framework.bundler.testutils.getCurrentKotlinVersion
import com.prof18.kmp.framework.bundler.testutils.getDefaultKotlinVersion
import com.prof18.kmp.framework.bundler.testutils.hasDefaultXCFrameworkSupport
...
class XCFrameworkLegacyTasksBuildTest(
    private val kotlinVersion: String,
) : BaseBuildTaskTest(frameworkType = FrameworkType.XC_FRAMEWORK_LEGACY_BUILD) {
