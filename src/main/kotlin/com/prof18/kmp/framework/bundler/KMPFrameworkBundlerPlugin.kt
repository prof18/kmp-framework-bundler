...
import com.prof18.kmp.framework.bundler.task.common.registerPrepareCocoaRepoForDebugTasks
import com.prof18.kmp.framework.bundler.task.common.registerPrepareCocoaRepoForReleaseTasks
import com.prof18.kmp.framework.bundler.task.fatframework.registerBuildDebugFatFrameworkTask
import com.prof18.kmp.framework.bundler.task.fatframework.registerBuildReleaseFatFrameworkTask
import com.prof18.kmp.framework.bundler.task.fatframework.registerPublishDebugFatFrameworkTask
import com.prof18.kmp.framework.bundler.task.fatframework.registerPublishReleaseFatFrameworkTask
import com.prof18.kmp.framework.bundler.task.registerGenerateCocoaPodRepositoryTask
import com.prof18.kmp.framework.bundler.task.xcframework.legacy.registerBuildLegacyDebugXCFrameworkTask
import com.prof18.kmp.framework.bundler.task.xcframework.legacy.registerBuildLegacyReleaseXCFrameworkTask
import com.prof18.kmp.framework.bundler.task.xcframework.registerBuildDebugXCFrameworkTask
import com.prof18.kmp.framework.bundler.task.xcframework.registerBuildReleaseXCFrameworkTask
import com.prof18.kmp.framework.bundler.task.xcframework.registerPublishDebugXCFrameworkTask
import com.prof18.kmp.framework.bundler.task.xcframework.registerPublishReleaseXCFrameworkTask
